    ...
    def train(self, epochs, batch_size=1, sample_interval=50):
        ...
        for epoch in range(epochs):
            ...
            if accuracy >= accuracy_prev:
                ...
                self.generator.save("saved_model/gen_model%d_simp.h5" % (epoch))
                self.combined.save("saved_model/both_model%d_simp.h5" % (epoch))
                self.discriminator.save("saved_model/dis_model%d_simp.h5" % (epoch))
    ...
    def sample_images(self, epoch, batch_i):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("images/%s/%d_%d_simp.png" % (self.dataset_name, epoch, batch_i))
        plt.close()
...
if __name__ == '__main__':
    #train
    gan = Pix2Pix()
    gan.train(epochs=50, batch_size=5, sample_interval=200)
